        ...
        <div className="builder-column" class="div-5">
          <div class="div-6">
            ...
            <div class="div-9">
              ...
              <div class="div-11">
                <p>Builder Visual CMS
                  <strong />
                  is the first and only headless CMS with a powerful
                  drag-and-drop visual editor that lets you build and optimize
                  digital experiences with speed and flexibility</p>
              </div>
            </div>
          ...
          <div class="div-15">
            <div class="div-16">
              <div class="div-17">
                ...
                <div className="builder-image-sizer" class="div-18" />
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="builder-columns" class="div-22">
      ...
      <div className="builder-column" class="div-27">
        <div class="div-28">
          <div class="div-29">
            <div
              dangerouslySetInnerHTML={{ __html: '<svg  width=&quot;30&quot;  height=&quot;30&quot;  viewBox=&quot;0 0 25 24&quot;  fill=&quot;none&quot;  xmlns=&quot;http://www.w3.org/2000/svg&quot; >  <path  fill-rule=&quot;evenodd&quot;  clip-rule=&quot;evenodd&quot;  d=&quot;M11.25 21V3.00001C11.25 1.9178 12.5318 1.34693 13.3362 2.07089L23.3362 11.0709C23.8879 11.5674 23.8879 12.4326 23.3362 12.9291L13.3362 21.9291C12.5318 22.6531 11.25 22.0822 11.25 21ZM20.63 12L13.75 5.80701V18.192L20.63 12Z&quot;  fill=&quot;#45B7CF&quot;  />  <path  fill-rule=&quot;evenodd&quot;  clip-rule=&quot;evenodd&quot;  d=&quot;M1.25 21V3.00001C1.25 1.9178 2.5318 1.34693 3.33621 2.07089L13.3362 11.0709C13.8879 11.5674 13.8879 12.4326 13.3362 12.9291L3.33621 21.9291C2.5318 22.6531 1.25 22.0822 1.25 21ZM10.63 12L3.75 5.80701V18.192L10.63 12Z&quot;  fill=&quot;#45B7CF&quot;  /> </svg> ' }} />
          </div>
      ...
      <div className="builder-columns" class="div-38">
        <div className="builder-column" class="div-39">
          ...
          <div class="div-41">
            ...
            <div class="div-45">
              <p>
                This isn't just another page builder. Our powerful visual editor
                lets you drag-and-drop to create and customize anything, from
                header to footer. Start with our templates, import your current
                pages, or start from scratch to quickly bring your vision to
                life. (And remember, no developer required!)
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="builder-column" class="div-46">
          <div class="div-47">
            <div class="div-48">
              ...
              <div className="builder-image-sizer" class="div-49" />
            </div>
          </div>
        </div>
      </div>
...
<div class="div-50">
  <div class="div-51">
          ...
          <div className="builder-columns" class="div-56">
            <div className="builder-column" class="div-57">
              <div class="div-58">
                ...
                <div class="div-60">
                  <p>
                    Get started with our templates, import your own, or start
                    from scratch.
                  </p>
                </div>

                <div class="div-61">
                  <div href="https://apps.shopify.com/builder-2" class="div-62">
                    <p>Start Building</p>
                  </div>
                  ...
                  <div class="div-63">
                    <div class="div-64">
                      ...
                      <div className="builder-image-sizer" class="div-65" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="builder-column" class="div-66">
              <div class="div-67">
                <div class="div-68">
                  ...
                  <div className="builder-image-sizer" class="div-69" />
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="builder-columns" class="div-73">
                <div className="builder-column" class="div-74">
                  <div class="div-75">
                    <div class="div-76">
                      ...
                      <div className="builder-image-sizer" class="div-77" />
                    </div>
                  </div>
                </div>
                ...
                <div className="builder-column" class="div-78">
                  <div class="div-79">
                    ...
                    <div class="div-81">
                      <p>
                        Drag-and-drop it all, from text, images, and videos to
                        products, collections, and add-to-carts.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="builder-columns" class="div-85">
            <div className="builder-column" class="div-86">
              <div class="div-87">
                ...
                <div class="div-89">
                  <p>
                    Completely customize the look and feel of your content and
                    make it come alive with animations.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="builder-column" class="div-90">
              <div class="div-91">
                <div class="div-92">
                  ...
                  <div className="builder-image-sizer" class="div-93" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="builder-columns" class="div-97">
              ...
              <div class="div-99">
                <div class="div-100">
                  <div class="div-101">
                    ...
                    <div className="builder-image-sizer" class="div-102" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="builder-column" class="div-103">
              <div class="div-104">
                ...
                <div class="div-106">
                  <p>
                    Create the optimal end-to-end experience, from high-impact
                    pages (collections, product pages, cart) to the essential
                    touches (pop-ups, slide-ups, announcement bars).
                  </p>
                </div>
              </div>
            </div>
    ...
    <a href="https://apps.shopify.com/builder-2" target="_blank" class="a-2">
      <div class="div-107" />
    </a>
    ...
    <div class="div-108">
      <div class="div-109">
        <a href="https://apps.shopify.com/builder-2" class="a-3">
          <div class="div-110"><a href="" target="_self">
              Try for free </a></div>
        </a>
          ...
          <div className="builder-columns" class="div-112">
            <div className="builder-column" class="div-113">
              <div class="div-114">
                ...
                <div class="div-118">
                  <p>
                    With Theme Studio, you can personalize your storefront by
                    creating targeted page-level or content-specific experiences
                    for different customer segments. Perform unlimited A/B tests
                    to understand how and if changes impact funnel performance.
                    Plus, our dashboards tell you just how much money each
                    change made, and allows you to revert any misstep instantly.
                    It's like magic.
                  </p>
                </div>
              </div>
              ...
              <div class="div-120">
                <div class="div-121">
                  <div class="div-122">
                    ...
                    <div className="builder-image-sizer" class="div-123" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="builder-columns" class="div-129">
              ...
              <div class="div-131">
                <div class="div-132">
                  <div class="div-133">
                    ...
                    <div className="builder-image-sizer" class="div-134" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="builder-column" class="div-135">
              <div class="div-136">
                ...
                <div class="div-140">
                  <p>
                    The best merchants find ways to test, iterate, measure, and
                    then do it better the next time. Theme Studio's analytics
                    suite comes with site, page, and content-level insights, as
                    well as heat maps that show both engagement (nice) and
                    impact on conversation (very nice).
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="builder-columns" class="div-144">
                <div className="builder-column" class="div-145">
                  <div class="div-146">
                    ...
                    <div class="div-150">
                      <p>
                        Stop installing an endless number of apps. Theme Studio
                        comes with so much power and so many capabilities,
                        you'll be able to uninstall apps that needlessly slow
                        down your storefront and only keep the ones providing
                        real value.
                      </p>
                    </div>
                  </div>
                ...
                <div className="builder-column" class="div-151">
                  <div class="div-152">
                    <div class="div-153">
                      ...
                      <div className="builder-image-sizer" class="div-154" />
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="div-157">
      <div class="div-158">
        ...
        <div className="builder-image-sizer" class="div-159" />
      </div>
    </div>

    <div class="div-160">
      <p><span className="underline-3">Frequently</span>
        Asked Questions</p>
    </div>

    <div class="div-161">
      <p>
        Have a different question about how Builder.io works or the pricing
        plans available? Try getting in touch with one of our specialists via
        live chat.
      </p>
    </div>
