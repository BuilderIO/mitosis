                    ...
                    >
                      ...
                      <div
                        css={{
                          ...
                          '@media (max-width: 640px)': { paddingBottom: '0px' },
                        }}
                      >
                        <div
                          href="https://apps.shopify.com/builder-2"
                ...
                >
                  <div
                    css={{
                      ...
                      '@media (max-width: 640px)': { marginTop: '0px' },
                    }}
                  >
                    <div
                      className="builder-columns"
                        ...
                        >
                          <div
                            css={{
                              ...
                              '@media (max-width: 640px)': { fontSize: '32px' },
                            }}
                          >
                    ...
                    >
                      <div
                        css={{
                          ...
                          paddingRight: '20px',
                          marginRight: 'auto',
                          '@media (max-width: 991px)': { paddingTop: 'px' },
                          '@media (max-width: 640px)': {
                            width: 'auto',
                            height: 'auto',
                            marginTop: '0px',
                      ...
                      >
                        <div
                          css={{
                            ...
                            paddingBottom: '30px',
                            marginBottom: 'auto',
                            '@media (max-width: 640px)': { marginTop: '20px' },
                          }}
                        >
                          <div
                            css={{
