...
test('outputs version', function() {
  return __awaiter(void 0, void 0, void 0, function() {
    var output
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, cli('--version')]
        case 1:
          output = _a.sent()
...
test('outputs help', function() {
  return __awaiter(void 0, void 0, void 0, function() {
    var output
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, cli('--help')]
        case 1:
          output = _a.sent()
          expect(output).toContain(version)
          return [2 /*return*/]
...
test('strips out builder components by default', function() {
  return __awaiter(void 0, void 0, void 0, function() {
    var filepath, output
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            cli('compile --from=builder --to=react ' + filepath)
          ]
        case 1:
          output = _a.sent()
...
test('--builder-components keeps builder components', function() {
  return __awaiter(void 0, void 0, void 0, function() {
    var filepath, output
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            cli(
              'compile --builder-components --from=builder --to=react ' +
                filepath
            )
          ]
        case 1:
