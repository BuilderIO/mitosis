    ...
    return __awaiter(void 0, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            config = __assign(
              { targets: [], dest: 'dist', files: 'src/*' },
              get_jsx_lite_config_1.getJsxLiteConfig()
            )
            cwd = process.cwd()
                                ...
                                return __awaiter(
                                  ...
                                  function() {
                                    ...
                                    return __generator(this, function(_e) {
                                      switch (_e.label) {
                                        case 0:
                                          outPath = path_1.default.resolve(
                                            cwd,
                                            config.dest,
                                            target,
                                            filePath
                                        ...
                                        case 1:
                                          ...
                                          return [3 /*break*/, 19]
                                        case 2:
                                          output = core_1.componentToReact(
                                            parsed
                                          )
                                          extension = '.tsx'
                                          return [3 /*break*/, 20]
                                        case 3:
                                          ...
                                          return [3 /*break*/, 20]
                                        case 4:
                                          output = core_1.componentToAngular(
                                            parsed
                                          )
                                          return [3 /*break*/, 20]
                                        case 5:
                                          output = core_1.componentToSvelte(
                                            parsed
                                          )
                                          extension = '.svelte'
                                          return [3 /*break*/, 20]
                                        case 6:
                                          output = JSON.stringify(
                                            core_1.componentToBuilder(parsed),
                                            null,
                                            2
                                          )
                                          extension = '.json'
                                          return [3 /*break*/, 20]
                                        case 7:
                                          output = core_1.componentToSolid(
                                            parsed
                                          )
                                          extension = '.tsx'
                                          return [3 /*break*/, 20]
                                        case 8:
                                          output = core_1.componentToHtml(
                                            parsed
                                          )
                                          extension = '.html'
                                          return [3 /*break*/, 20]
                                        case 9:
                                          output = core_1.componentToCustomElement(
                                            parsed
                                          )
                                          return [3 /*break*/, 20]
                                        case 10:
                                        ...
                                        case 13:
                                          ...
                                          return [3 /*break*/, 15]
                                        case 14:
                                          outPath_1 = path_1.default.resolve(
                                            cwd,
                                            config.dest,
                                            target,
                                            filePath_1
                                          )
                                          filePath_1 = outPath_1.replace(
                                            /\.lite\.(j|t)sx$/,
                                            extension
                                          )
