      ...
      return __generator(this, function(_q) {
        switch (_q.label) {
          case 0:
            ...
            if (
              (_f =
                (_e = opts.l) !== null && _e !== void 0 ? _e : opts.list) !==
                null && _f !== void 0
                ? _f
                : false
            ) {
            ...
            from_ = strings.camelCase(
              (_h =
                (_g = opts.f) !== null && _g !== void 0 ? _g : opts.from) !==
                null && _h !== void 0
                ? _h
                : 'jsxLite'
            )
            to = strings.camelCase(
              (_j = opts.t) !== null && _j !== void 0 ? _j : opts.to
            )
            out = (_k = opts.o) !== null && _k !== void 0 ? _k : opts.out
            force = (_l = opts.force) !== null && _l !== void 0 ? _l : false
            dryRun =
              (_o =
                (_m = opts.dryRun) !== null && _m !== void 0 ? _m : opts.n) !==
                null && _o !== void 0
                ? _o
                : false
            outDir = opts.outDir
            ...
            generatorOpts = {
              prettier:
                (_p = opts.prettier) !== null && _p !== void 0 ? _p : true,
              plugins: plugins,
              format: opts.format,
              prefix: opts.prefix,
          ...
          case 3:
            ...
            if (force === false && out && filesystem.exists(out) === 'file') {
              print.error(
                out +
                  ' already exists. Use --force if you want to overwrite existing files.'
              )
              process.exit(1)
            }
            try {
              ...
              switch (from_) {
                case 'jsxLite':
                  ...
                  break
                case 'builder':
                  json = core_1.builderContentToJsxLiteComponent(
                    JSON.parse(data)
                  )
                  break
                default:
